...
if (!defined('\IPS\SUITE_UNIQUE_KEY')) {
    ...
    class _HOOK_CLASS_ extends \IPS\Theme\Dev\Template
    {
    }
...
class toolbox_hook_DevTemplate extends _HOOK_CLASS_
{
    ...
    //     $template = \null;
    //     if (!Request::i()->isAjax() && \IPS\QUERY_LOG && Settings::i(
    //         )->dtprofiler_enabled_templates && $this->app !== 'dtprofiler' && ($this->app === 'core' && $bit !== 'cachingLog')) {
    //         $name = \null;
    //         $app = $this->app;
    ...
    //     if (\IPS\IN_DEV === \true && !Request::i()->isAjax() && \IPS\QUERY_LOG && Settings::i(
    //         )->dtprofiler_enabled_templates && $this->app !== 'dtprofiler' && ($this->app === 'core' && $bit !== 'cachingLog') && $this->app !== 'dtprofiler') {
