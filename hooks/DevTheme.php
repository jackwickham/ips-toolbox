...
protected static function _getCssPath($app, $location = null, $path = null)
{
    if( defined('DT_THEME') && defined('DT_THEME_ID') && DT_THEME === true ){
        ...
        $themedir = \IPS\ROOT_PATH . '/themes/'.DT_THEME_ID.'/css/' . $app . '/' . $location . '/' . $path . '/';
...
protected static function _getHtmlPath($app, $location = null, $path = null)
{
    if( defined('DT_THEME') && defined('DT_THEME_ID') && DT_THEME === true ){
        //$this->sourceFolder = \IPS\ROOT_PATH . '/themes/28/html/' . $app . '/' . $templateLocation . '/' . $templateName . '/';
        $themedir = \IPS\ROOT_PATH . '/themes/'.DT_THEME_ID.'/html/' . $app . '/' . $location . '/';
    ...
    protected static function _getResourcePath( $app, $location=null, $path=null )
    {
        if( defined('DT_THEME') && defined('DT_THEME_ID') && DT_THEME === true ) {
            ...
            return rtrim(
                    \IPS\ROOT_PATH . '/themes/' . DT_THEME_ID . '/resources/' . $app . '/' . $location . '/' . $path,
                    '/'
    ...
    public function css($file, $app = null, $location = null)
    {
        ...
        if( defined('DT_THEME') && defined('DT_THEME_ID') && DT_THEME === true ) {
            ...
            foreach($return as $k => $v ){
                $new[$k] = str_replace('applications/core/interface/css/css.php', 'applications/toolbox/interface/css/css.php', $v);
            }
