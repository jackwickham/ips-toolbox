...
class toolbox_hook_SandboxedTemplate extends _HOOK_CLASS_
{
    ...
    public function __call( $name, $args ){
        ...
        if ( !Request::i()->isAjax() && \IPS\QUERY_LOG && Settings::i()->dtprofiler_enabled_templates && \in_array( Member::loggedIn()->member_id, $can ) && $this->template->app !== 'dtprofiler' && ( $this->template->app === 'core' && $name === 'cachingLog' ) ) {
